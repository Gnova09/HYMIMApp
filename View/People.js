...
export const People = () => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.twelve}>Revelador Genero</Text>
            ...
            <Text><Text style={{fontWeight: "bold"}}>Genero:</Text> {data.gender}</Text>
            <Text><Text style={{fontWeight: "bold"}}>Probabilidad:</Text> {data.probability}</Text>
            </View>
        </View>
    )
}
